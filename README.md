...
____________________
    ...
    $ git clone https://github.com/Saikohackerteamrm/Termux-Banner
    $ cd Termux-Banner
    $ bash requirement.sh
...
_______________________________________
    ...
    apt update -y && apt upgrade -y && pkg install git -y && pkg install python -y  && git clone https://github.com/Saikohackerteamrm/Termux-Banner && cd Termux-Banner && bash requirement.sh
 ### Hi there 👋
